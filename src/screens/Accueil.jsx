...
const Accueil = () => {
  const itemData = [
    ...
    {
      img: 'img/IMG_4123.webp',
      title: 'Image',
    },
    {
      img: 'img/IMG_4204.webp',
      title: 'Image',
    },
    {
      img: 'img/IMG_4284.webp',
      title: 'Image',
    },
  ];
  ...
  const transitions = useTransition(index, {
    from: {
      opacity: 1,
      transform: leftToRight ? 'translateX(100%)' : 'translateX(-100%)',
    },
